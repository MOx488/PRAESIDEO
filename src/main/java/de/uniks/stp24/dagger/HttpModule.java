...
public class HttpModule {
    ...
    @Provides
    @Singleton
    FriendsApiService friendsApiService(Retrofit retrofit) {
        return retrofit.create(FriendsApiService.class);
    }
    ...
    @Provides
    @Singleton
    ShipsApiService shipsApiService(Retrofit retrofit) {
        return retrofit.create(ShipsApiService.class);
    }
